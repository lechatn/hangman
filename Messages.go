...
func WordFind(word string, display string, score int, win_series int, life int) (int) { // Function who verify if the user have find the word and display the message of congrats
	clear := "\033[H\033[2J"
